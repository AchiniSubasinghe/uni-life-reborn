...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative py-28 px-6 overflow-hidden">
      {/* orb */}
      <div className="orb w-[600px] h-[600px] bg-violet-800 bottom-[-10%] left-[-10%]" style={{ opacity: 0.08 }} />
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-indigo-300 text-sm font-medium tracking-widest uppercase mb-3">Contact</p>
            ...
            {sent ? (
              <div className="flex flex-col items-center justify-center h-full py-12 text-center">
                ...
                <button
                  ...
                  className="mt-6 text-indigo-300 text-sm hover:text-indigo-200 transition-colors"
                >
          ...
          >
            {[
              ...
              return (
                ...
                >
                  <div className="glass rounded-xl p-2.5 text-indigo-300 flex-shrink-0">
