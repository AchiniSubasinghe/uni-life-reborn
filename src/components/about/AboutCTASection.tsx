        ...
        <div className="flex flex-wrap justify-center gap-4 fade-in-up delay-200">
          ...
          <Link href="/contact">
            <Button
              variant="outline"
              size="lg"
              className="bg-card text-gray-200 px-10 py-6 rounded-xl font-bold text-lg border-2 border-border hover:border-teal-500 hover:text-teal-400 transition-all duration-300"
            >
              Contact Us
            </Button>
          </Link>
