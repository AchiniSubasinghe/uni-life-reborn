...
const navItems = [
  ...
  { href: "/student/browse", label: "Browse Services", icon: Search },
      ...
      >
        ...
        <div className="flex-1 flex justify-center">
          <Link href="/student/dashboard" className="flex items-center gap-2">
            ...
            <span className="font-semibold text-white">UniLife</span>
          </Link>
        </div>
      </header>
      ...
      >
          ...
          <div className="h-14 flex items-center justify-between px-5" style={{ borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
            <Link href="/student/dashboard" className="flex items-center gap-2">
              ...
              <span className="font-semibold text-white text-sm">UniLife</span>
            </Link>
