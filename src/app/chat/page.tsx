    ...
    >
      ...
      <div
        className={`w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center ${
          isUser ? "glass-strong" : "bg-indigo-500/20 border border-indigo-400/20"
        }`}
      >
        {isUser ? <User className="w-3.5 h-3.5 text-white/70" /> : <Bot className="w-3.5 h-3.5 text-indigo-300" />}
      </div>
      ...
      <div
        ...
        } ${isLatest ? "shadow-[0_4px_20px_rgba(100,80,255,0.12)]" : ""}`}
      >
...
function TypingIndicator() {
  return (
    <div className="flex items-end gap-2.5">
      <div className="w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center bg-indigo-500/20 border border-indigo-400/20">
    ...
    <main className="site-bg min-h-screen flex flex-col">
      ...
      <div className="glass border-b border-white/[0.06] sticky top-0 z-10">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-full bg-indigo-500/20 border border-indigo-400/20 flex items-center justify-center">
      ...
      <div className="flex-1 max-w-3xl w-full mx-auto px-4 py-6 flex flex-col gap-5 overflow-y-auto">
        ...
        {messages.length === 0 && (
          ...
          >
            <div className="w-16 h-16 rounded-2xl bg-indigo-500/15 border border-indigo-400/20 flex items-center justify-center mb-5">
