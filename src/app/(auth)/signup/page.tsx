...
export default function SignUpPage() {
  return (
    <div className="site-bg min-h-screen flex items-center justify-center px-6 overflow-hidden relative">
      ...
      <div className="orb w-[400px] h-[400px] bg-violet-700 bottom-[-5%] right-[-5%]" style={{ opacity: 0.18 }} />
      ...
      <div className="relative z-10 w-full max-w-3xl">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <Link href="/signup/student" className="group block">
            <div
              className="relative overflow-hidden rounded-2xl p-8 flex flex-col gap-4 transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_8px_40px_rgba(100,80,255,0.18)]"
              style={{
            ...
            >
              ...
              <div className="flex items-center gap-2 text-indigo-300 text-sm font-medium mt-auto pt-2">
          ...
          <Link href="/signup/provider" className="group block">
            <div
              className="relative overflow-hidden rounded-2xl p-8 flex flex-col gap-4 transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_8px_40px_rgba(140,80,255,0.18)]"
              style={{
                background: 'rgba(255,255,255,0.045)',
                backdropFilter: 'blur(24px)',
                border: '1px solid rgba(255,255,255,0.09)',
            ...
            >
              ...
              <div className="flex items-center gap-2 text-violet-300 text-sm font-medium mt-auto pt-2">
        ...
        <p className="text-center text-white/35 text-sm mt-8">
          ...
          <Link href="/login" className="text-indigo-300 hover:text-indigo-200 transition-colors">
            Sign in
          </Link>
        </p>
      </div>
